...
class kutuphane:
    ...
    def kitap_kaydet(self):
        kayit =  str(("\n" + kitap_adi.get() + "|" + yazar_adi.get() + "|" + tur.get() + "|" + isbn.get() + "|" + yayinevi.get() + "|" + yayin_yili.get()))
        f = open("output.txt", 'a')
    ...
    def kitapbak(self):
        ...
        self.butonKitapTürü = Button(pencere4, text="Ara", bg="cornflowerblue", fg="black", cursor="star", font="bold", command=kitapTürü)
